package com.example.googlefitsensor.permissionUtil;
...
import com.example.googlefitsensor.R;
...
//                neverAskedDialog(object, listener, neveraskedperms);
    ...
    private static void neverAskedDialog(final Object object, final PermissionListener listener, final ArrayList<String> neveraskedperms) {
        dialog = new AlertDialog.Builder(getActivity(object), com.example.googlefitsensor.R.style.MyAlertDialogStyle)
